...
const distance_m_isInt = body("distance_m", "distance_m must be an integer and not smaller than zero").isInt({
  min: 0,
});

const duration_ms_isInt = body("duration_ms", "duration_ms must be an integer and not smaller than zero").isInt({
  min: 0,
});

const laps_isInt = body("laps", "laps must be an integer and not smaller than zero").isInt({ min: 0 });
